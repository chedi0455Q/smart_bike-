...
CREATE TABLE produits (
    ...
    categorie   VARCHAR(50)   NOT NULL DEFAULT 'urban',
    autonomie   INT           NOT NULL DEFAULT 60,
    puissance   INT           NOT NULL DEFAULT 250,
    poids       DECIMAL(4,1)  NOT NULL DEFAULT 18.0,
...
('Speed Demon S45',
 ...
 4299.00, 'https://images.unsplash.com/photo-1571188654248-7a89213915f7?w=800', 'speed', 120, 600, 16.5, 4.8, 3),
